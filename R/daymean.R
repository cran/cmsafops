...
daymean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE, nc = NULL) {
  dayx_wrapper(3, var, infile, outfile, nc34, overwrite, verbose = verbose, nc = nc)
}